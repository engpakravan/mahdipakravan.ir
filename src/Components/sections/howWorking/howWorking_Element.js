...
function howWorking_Element(props){
    ...
    return(
        props.display.decoration === 'img_right' ? (
            <Row className="pt-5 d-flex align-items-center">
                <Col lg={8} className="d-flex flex-column justify-content-center d-lg-block order-2 order-lg-1">
                    {getStepText('مرحله اول' , 'در مورد کسب و کارتون صحبت میکنیم !')}
